...
Навык — конкретная развиваемая область. Пользователь может создавать, архивировать и редактировать навыки.
...
2. Определить, какие шаблоны применимы к указанному дню недели.
...
Просроченные задачи не переносятся автоматически. Они остаются привязаны к исходной дате и доступны через историю.
...
Удаление навыка или шаблона с историей должно быть логическим архивированием, а не физическим удалением.
...
- [ ] Инициализировать Next.js с TypeScript strict.
- [ ] Подключить Tailwind CSS и shadcn/ui.
- [ ] Настроить lint, typecheck, Vitest и Playwright.
- [ ] Добавить Dockerfile, Docker Compose и Caddyfile.
- [ ] Настроить `.env.example` и типизированную проверку окружения.
- [ ] Создать `README.md`, `CHANGELOG.md` и `TASKS.md`.
...
- [ ] Настроить внешний backup PostgreSQL.
