...
> Статус: **Этап 3 — повторения и серии**. К игровому циклу добавлены шаблоны
> повторяющихся задач, ленивое создание задач дня без cron, серии и отмена
> выполнения. Квесты и достижения — далее (см. [`TASKS.md`](./TASKS.md)).
