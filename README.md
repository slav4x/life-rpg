...
«Прогресс» показывает статистику за 7/30 дней и всё время: в XP периода
входят выполненные задачи и награды квестов, а распределение характеристик следует выбранному
периоду. Там же доступны серии по каждому повторению и обзор текущей календарной недели:
XP, выполненные и пропущенные задачи, завершённые и просроченные квесты, основные направления.
