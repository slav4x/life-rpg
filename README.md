...
активировать или сохранить как черновик. Список фильтруется по типу, а фильтр сохраняется в URL
вместе с выбранной вкладкой. Активные квесты сортируются по ближайшему дедлайну, просроченные
...
Экран «Навыки» группирует навыки по характеристикам с уровнем и прогрессом, поддерживает
поиск и фильтр по характеристике; навык получает
...
шаблонов в профиле показывает расписание и связанный навык, позволяет восстановить шаблон и
...
шаблонами, выход, версионированный экспорт и импорт данных, включая недельные фокусы.
