...
`высокий / обычный / низкий`, обзор
просроченных/сегодняшних/ближайших семи дней, быстрый календарный переход и результат
начисления (toast). Просроченные задачи собраны в единый список: их можно массово перенести,
пропустить или удалить. Долги старше семи дней нельзя завершить на исходной дате, но можно
перенести на сегодня или будущее. XP с клиента не принимается — считается только на сервере.
Будущие задачи завершить нельзя; задним числом доступны текущий и семь предыдущих локальных дней.
