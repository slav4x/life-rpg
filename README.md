...
> Статус: **Этап 4 — квесты и достижения**. Добавлены квесты с шагами и
> XP-наградой, стартовый набор достижений и нижняя навигация. Экраны навыков,
> прогресса и профиля — далее (см. [`TASKS.md`](./TASKS.md)).
